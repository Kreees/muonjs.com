        ...
        m.get_view_by_name = function(view_type,view_name,_context_name,pack,recursive){
            ...
            try{
                ...
                if (!View && (view_type == "model" || view_type == "collection") && _context_name){
                    var context_name = _context_name.replace(/:/g,".").split("."),
                        _view_name = view_name;
                    for(var i in context_name)
                        _view_name = _view_name.replace(RegExp("_"+context_name[i]+"$"),"");
                    if (_view_name != view_name)
                        try{ return m.get_view_by_name(view_type,_view_name,_context_name,pack,true); }
                        catch(e){}
                }
                if (!View && (view_type == "model" || view_type == "collection") && _context_name){
